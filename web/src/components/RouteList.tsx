      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
        ...
        <select
          ...
          className="w-full p-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500"
        >
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="showAllRoutes" className="ml-2 text-sm text-gray-700 dark:text-gray-200">
          ...
          {selectedRoute && (
            <button
              ...
              className="w-full px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            >
              Clear Selection
            </button>
          )}
